...
function entryToPacket(e: LogEntry, index: number): RxPacket {
  return {
    ...
    dest: String(e.dest ?? ''),
    echo: String(e.echo ?? ''),
    ptype: String(e.ptype ?? ''),
    cmd: String(e.cmd ?? '???'),
    args_named: (Array.isArray(e.args_named) ? e.args_named : []) as RxPacket['args_named'],
    args_extra: (Array.isArray(e.args_extra) ? e.args_extra : []) as string[],
    size: (e.size as number) ?? 0,
    crc16_ok: (e.crc16_ok as boolean | null) ?? null,
    crc32_ok: (e.crc32_ok as boolean | null) ?? null,
    ...
    csp_header: (typeof e.csp_header === 'object' && e.csp_header !== null)
      ? e.csp_header as Record<string, number> : null,
    ax25_header: (e.ax25_header as string | null) ?? null,
