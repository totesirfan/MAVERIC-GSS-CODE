    ...
    <div className="card live" data-component="HeroCard" data-kind="bus">
      <div className="card-head live-bg">
        <div className="card-head-left">
          ...
          <span className="card-sub">V_BUS</span>
        </div>
      ...
      <div className="hero-card-body">
        ...
        <div title="V_BUS position in operating range · low-alarm 6.5 V · nominal 8.5–9.3 V · high-alarm 9.5 V">
          <div
            className="soc-gauge"
            data-gauge="V_BUS"
            role="img"
          ...
          >
            ...
            <div className="lim" style={{ left: `${(ALARM_LO - AXIS_LO) / AXIS_RANGE * 100}%` }} />
            <div
              className="lim"
              style={{
                left: `${(NOM_LO - AXIS_LO) / AXIS_RANGE * 100}%`,
            ...
            <div
              className="lim"
              style={{
                left: `${(ALARM_HI - AXIS_LO) / AXIS_RANGE * 100 - 0.5}%`,
          ...
          <div className="soc-axis">
            <span>6.0</span><span>6.5 lo</span><span>8.5 nom</span><span>9.5 V hi</span>
          </div>
        </div>
        {hasPrev && (
          <div className="delta-row" data-delta="V_BUS" title="Change since previous packet in this link">
